export const homeLocalKey = {
  ...
  viewMore: "tabs.home.headers.viewMore.label",
  addCard: "tabs.home.menu.addCard.label",
  activateCard: "tabs.home.menu.activateCard.label",
  promosAndDiscount: "tabs.home.menu.promosAndDiscount.label",
};
